...
//go:generate minimock -i github.com/mrVoldemar/crm_backend/internal/client/db.Client -o client_minimock.go -n ClientMock -p mocks
...
import (
	...
	mm_db "github.com/mrVoldemar/crm_backend/internal/client/db"
)
